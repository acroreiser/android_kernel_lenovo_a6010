...
#define	AUDIO_MAX_COMMON_IOCTL_NUM_STUB	141
#define AUDIO_SET_EFFECTS_CONFIG   _IOW(AUDIO_IOCTL_MAGIC, AUDIO_MAX_COMMON_IOCTL_NUM_STUB, \
				struct msm_hwacc_effects_config)
#define AUDIO_EFFECTS_SET_BUF_LEN _IOW(AUDIO_IOCTL_MAGIC, AUDIO_MAX_COMMON_IOCTL_NUM_STUB + 1, \
				struct msm_hwacc_buf_cfg)
#define AUDIO_EFFECTS_GET_BUF_AVAIL _IOW(AUDIO_IOCTL_MAGIC, AUDIO_MAX_COMMON_IOCTL_NUM_STUB + 2, \
				struct msm_hwacc_buf_avail)
#define AUDIO_EFFECTS_WRITE _IOW(AUDIO_IOCTL_MAGIC, AUDIO_MAX_COMMON_IOCTL_NUM_STUB + 3, void *)
#define AUDIO_EFFECTS_READ _IOWR(AUDIO_IOCTL_MAGIC, AUDIO_MAX_COMMON_IOCTL_NUM_STUB + 4, void *)
#define AUDIO_EFFECTS_SET_PP_PARAMS _IOW(AUDIO_IOCTL_MAGIC, AUDIO_MAX_COMMON_IOCTL_NUM_STUB + 5, void *)
