...
extern struct xfrm_state *xfrm_state_find(const xfrm_address_t *daddr,
					  ...
					  unsigned short family);
extern struct xfrm_state *xfrm_stateonly_find(struct net *net, u32 mark, u32 if_id,
...
struct xfrm_policy *xfrm_policy_bysel_ctx(struct net *net, u32 mark, u32 if_id,
					  ...
					  int *err);
struct xfrm_policy *xfrm_policy_byid(struct net *net, u32 mark, u32 if_id, u8, int dir, u32 id, int delete, int *err);
