...
struct xfrm_policy *xfrm_policy_bysel_ctx(struct net *net, u32 mark, u32 if_id, u8 type,
...
struct xfrm_policy *xfrm_policy_byid(struct net *net, u32 mark,  u32 if_id, u8 type,
