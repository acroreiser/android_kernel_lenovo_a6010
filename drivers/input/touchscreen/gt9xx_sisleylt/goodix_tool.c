...
static void tool_set_proc_name(char * procname)
{
    ...
    //sprintf(procname, "gmnode%04d%02d%02d", n_year, n_month, n_day);   //change by lix1o 
...
s32 tool_i2c_read_no_extra(u8* buf, u16 len)
{
    s32 ret = -1;
    s32 i = 0;
    s32 pos = 0;
    ...
    data = (u8*)kmalloc(IIC_MAX_TRANSFER_SIZE, GFP_KERNEL);
...
s32 tool_i2c_write_no_extra(u8* buf, u16 len)
{
    s32 ret = -1;
    s32 i = 0;
    s32 pos = 0;
