...
//modify by ELAN Robert at 2014/08/30
...
static void elan_epl_als_rawdata(void)
{
	struct elan_epl_data *epld = epl_data;
	struct i2c_client *client = epld->client;
	static int last_lux = 0, active_count = 0;
#if DYNAMIC_INTT /*DYNAMIC_INTT*/
    ...
    {
    		/*Bug_307283, heming@wt, Reboot phone in low light the screen keep high brightness, Begin*/
    		...
    		/*Bug_307283, heming@wt, Reboot phone in low light the screen keep high brightness, End*/	
    		{	
