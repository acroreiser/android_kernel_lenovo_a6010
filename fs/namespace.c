...
#ifdef CONFIG_ANDROID_TREBLE_MOUNT_LEGACY_SURFACEFLINGER
		...
		const char *type_page, unsigned long flags, void *data_page)
{
	...
	else
	{
		...
		{
			flags2 |= MS_BIND;
			kern_path("/system/bin/surfaceflinger", LOOKUP_FOLLOW, &path2);
			do_loopback(&path2, "/vendor/bin/surfaceflinger-gles", flags2 & MS_REC);
			path_put(&path2);
			shot = 1;
		}
#endif
